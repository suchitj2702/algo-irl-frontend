   ...
   {editorError ? (
    <div className="p-4 text-button-foreground">
     <div className="mb-4">
      ...
      <ul className="list-disc list-inside text-sm text-content-subtle mb-4">
    ...
    <Editor
     ...
     theme={theme}
     loading={<div className="editor-loading p-4 text-button-foreground">Loading Monaco Editor...</div>}
    />
   )}
  </div>
 );
